...
class FeatureStudioClient():
    ...
    def get_feature_studio_paths(self, document_path: Path) -> list[Path]:
    ...
    def get_feature_studios(self, document_path: Path) -> list[object]:
    ...
    def extract_paths(self, elements: list[object], document_path: Path) -> list[Path]:
        result = []

...
const actionInfo: ActionInfo = {
    ...
    description:
        "Create a version and push it to one or more linked parent documents. but like, cooler",
...
export function PushVersionRecursive() {
    const pushVersionRecursiveMutationFn = async (
        args: PushVersionRecursiveArgs
    ) => {
